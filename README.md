...
`n8n-nodes-thordata` v0.1.0 is an n8n SERP API community node for Thordata.
...
2. Select the only v0.1.0 **Resource**, **SERP API**.
...
v0.1.0 does not expose Web Scraper. A later version may add another resource without changing existing `resource=serp` workflows.
